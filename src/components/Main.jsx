...
// import ButtonGreenLarge from "./ButtonGreenLarge";
// // import GallerySlider from "./GallerySlider.jsx";
// import ButtonOutlineGreenLarge from "./ButtonOutlineGreenLarge.jsx";
//
// function Main() {
//     return (
//         <>
...
//                                     <ButtonGreenLarge urlLink="#" text="View Events"/>
...
//                 {/* eslint-disable-next-line react/no-unescaped-entities */}
//                 <p className="text-slate-300 text-lg font-base mt-8 px-4 md:px-16 py-5 bg-white-transparent rounded-md border border-gray-600 leading-8">At CSS, we believe in the power of code to transform and shape the digital world. We've built a dynamic community that celebrates all aspects of coding, from web design to AI. Our philosophy, "Crafting coders, the dope way," fosters an inclusive space for coders at all skill levels. We thrive on collaboration, shared learning, and open communication. We offer resources, workshops, and events for all expertise levels. Driven by a shared passion for coding and its potential for positive change, we foster a culture of innovation and creativity. Join us at CSS, and embark on an exciting journey of creation, collaboration, and empowerment to become the best coders we can be.
//                 </p>
//             </section>
//             {/* Our Mission - Section */}
